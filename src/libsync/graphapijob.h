...
#ifndef GRAPHAPIJOB_H
#define GRAPHAPIJOB_H
 ...
 */
class GraphApiJob : public AbstractNetworkJob
{
    Q_OBJECT

protected:
    explicit GraphApiJob(AccountPtr account);
    ...
    /**
     * The base path for an GraphApiJob is always the same. But it could be the case that
